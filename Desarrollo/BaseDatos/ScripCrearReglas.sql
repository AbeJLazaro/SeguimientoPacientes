...
#PacienteHistorico
DELIMITER |
CREATE TRIGGER ActualizaPacienteTg 
...
DELIMITER |
CREATE TRIGGER DeletePacienteTg
...
DELIMITER |
CREATE TRIGGER DesactivoOtroInsercionTg
...
DELIMITER |
CREATE TRIGGER ConsultaDeteccionDeleteTG
...
DELIMITER |
CREATE TRIGGER ConsultaDeteccionUpdateTG
...
DELIMITER |
CREATE TRIGGER ConsultaDeteccionInsertTG
...
#No se pueden borrar datos, solo se "actualizaran"
DELIMITER |
CREATE TRIGGER DiagnosticoDeleteTG
...
DELIMITER |
CREATE TRIGGER DiagnosticoUpdateTG
...
DELIMITER |
CREATE TRIGGER DiagnosticoInsertTG
...
#No se pueden borrar datos, solo se "actualizaran"
DELIMITER |
CREATE TRIGGER ResultadoLaboratorioDeleteTG
...
DELIMITER |
CREATE TRIGGER ResultadoLaboratorioUpdateTG
...
DELIMITER |
CREATE TRIGGER ResultadoLaboratorioInsertTG
...
#No se pueden borrar datos, solo se "actualizaran"
DELIMITER |
CREATE TRIGGER PacienteHistoricoDeleteTG
...
DELIMITER |
CREATE TRIGGER PacienteHistoricoUpdateTG
