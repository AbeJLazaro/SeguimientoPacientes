...
<body>
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="row my-3 mx-5 pt-3">
          <div class="col">
            <h1 class="text-center text-uppercase">Actualización de cita</h1>
          </div>
        </div>
        <!--Formulario-->
        <form class="mt-5 mb-3">
          ...
          <div class="form-group row m-3 aling-items-center align-self-center">
            <label for="FechaCitaAnterior" class="LabelPersonalizadoCampoLargo col-12 col-md-4 col-form-label text-center rounded my-1 text-capitalize">Fecha Anterior</label>
            <div class="col-12 col-md-8 my-1 p-0 px-md-3 ">
              <input maxlength="4" type="date" class="form-control col-form-label-lg" id="FechaCitaAnterior" placeholder="">
            </div>
          </div>
          <!--Fecha de cita nueva-->
          <div class="form-group row m-3 aling-items-center align-self-center">
            <label for="FechaCitaNueva" class="LabelPersonalizadoCampoLargo col-12 col-md-4 col-form-label text-center rounded my-1 text-capitalize">Fecha Nueva</label>
            <div class="col-12 col-md-8 my-1 p-0 px-md-3 ">
              <input maxlength="4" type="date" class="form-control col-form-label-lg" id="FechaCitaNueva" placeholder="">
            </div>
          </div>
          <!--Botones de opciones-->
  ...
  <script src="js/mainAC.js"></script>
