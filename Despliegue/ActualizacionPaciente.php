...
<head>
  ...
  <title>Actualización de Paciente</title>
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="row my-3 mx-5 pt-3">
          <div class="col">
            <h1 class="text-center text-uppercase"> Actualizacion de paciente</h1>
          </div>
        </div>
        ...
        <form class="mt-5 mb-3">
          ...
          <div class="row justify-content-end m-5" id="BotonesInicio">
            <div class="col-auto">
        ...
        <!--Formulario Para actualizar al paciente-->
        <form id="BusquedaEncontrada">
          ...
          <div class="form-group row m-2 aling-items-center align-self-center">
            <label for="ApPaterno" class="LabelPersonalizadoCampoLargo col-12 col-md-4 col-form-label text-center rounded my-1 text-capitalize">Apeido paterno</label>
            <div class="col-12 col-md-8 my-1 p-0 px-md-3">
          ...
          <div class="form-group row m-2 aling-items-center align-self-center">
            <label for="ApMaterno" class="LabelPersonalizadoCampoLargo col-12 col-md-4 col-form-label text-center rounded my-1 text-capitalize">Apeido materno</label>
            <div class="col-12 col-md-8 my-1 p-0 px-md-3">
          ...
          <div class="form-group col m-2 my-4 aling-items-center align-self-center" id="Tel1">
            <div class="row">
              <div class="input-group col-4 justify-content-md-center">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                    <input type="radio" aria-label="Large" id="Fijo1" name="Telefono1" checked="">
                  </div>
                </div>
              ...
              <div class="input-group col-4 justify-content-md-center">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                    <input type="radio" aria-label="Large" id="Celular1" name="Telefono1">
                  </div>
                </div>
            ...
            <div class="form-group row m-2 aling-items-center align-self-center">
              <label for="NumeroTelefono1" class="LabelPersonalizadoCampoLargo col-12 col-md-4 col-form-label text-center rounded my-1 text-capitalize">Numero</label>
              <div class="col-12 col-md-8 my-1 p-0 px-md-3">
          ...
          <div class="form-group col m-2 my-4 aling-items-center align-self-center" id="Tel2">
            <div class="row">
              <div class="input-group col-4 justify-content-md-center">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                    <input type="radio" aria-label="Large" id="Fijo2" name="Telefono2" checked="">
                  </div>
                </div>
              ...
              <div class="input-group col-4 justify-content-md-center">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                    <input type="radio" aria-label="Large" id="Celular2" name="Telefono2">
                  </div>
                </div>
            ...
            <div class="form-group row m-2 aling-items-center align-self-center">
              <label for="NumeroTelefono2" class="LabelPersonalizadoCampoLargo col-12 col-md-4 col-form-label text-center rounded my-1 text-capitalize">Numero</label>
              <div class="col-12 col-md-8 my-1 p-0 px-md-3">
          ...
          <div class="form-group col m-2 my-4 aling-items-center align-self-center" id="Tel3">
            <div class="row">
              <div class="input-group col-4 justify-content-md-center">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                    <input type="radio" aria-label="Large" id="Fijo3" name="Telefono3" checked="">
                  </div>
                </div>
              ...
              <div class="input-group col-4 justify-content-md-center">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                    <input type="radio" aria-label="Large" id="Celular3" name="Telefono3">
                  </div>
                </div>
            ...
            <div class="form-group row m-2 aling-items-center align-self-center">
              <label for="NumeroTelefono3" class="LabelPersonalizadoCampoLargo col-12 col-md-4 col-form-label text-center rounded my-1 text-capitalize">Numero</label>
              <div class="col-12 col-md-8 my-1 p-0 px-md-3">
          ...
          <div class="form-group row m-2 my-4 aling-items-center align-self-center">
            <label for="Email" class="LabelPersonalizadoCampoLargo col-12 col-md-4 col-form-label text-center rounded my-1 text-capitalize">Correo electronico</label>
            <div class="col-12 col-md-8 my-1 p-0 px-md-3">
          ...
          <div class="form-group row m-2 my-4 aling-items-center align-self-center">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <label class="LabelPersonalizadoCampoLargo input-group-text" for="Activo">Estado del paciente</label>
              </div>
              <select class="custom-select" id="Activo">
                <option value="1">ACTIVO</option>
                <option value="2">YA CON DIABETES MELLITUS</option>
                <option value="3">SIN VIGENCIA</option>
                <option value="4">ADSCRIPCION</option>
                <option value="5">OTRO</option>
              </select>
            </div>
          </div>
          <div id="EspecificarOtro" class="form-group m-2 my-4 aling-items-center align-self-center">
            <label for="Especificar" class="LabelPersonalizadoCampoLargo col-12 col-form-label text-center rounded my-3 text-capitalize">Especificar</label>
            <textarea class="form-control" id="Especificar" maxlength="100" rows="3" value=""></textarea>
          </div>
          <!--Botones finales-->
          <div class="row justify-content-end m-5">
            <div class="col-auto">
              <div class="btn-group align-self-center" role="group" >
                <button type="button" id="Regresar2" class="btn BotonPersonalizado btn-lg">Regresar</button>
