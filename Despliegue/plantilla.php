...
Objetivo:Declarar el formato de la cabecera y el pie de página de los documentos PDF de los reportes individuales
...
*/
	...
	class PDF extends FPDF
	{
		...
		function Header()
		{
			...
			$this->Cell(30);
			$this->Cell(120,10,'Reporte Individual',0,0,'C');
