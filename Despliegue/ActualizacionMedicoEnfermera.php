...
<head>
  ...
  <title>Actualización de Personal</title>
...
<body>
  <div class="container my-5"> 
    <div class="row">
      <div class="col">
        <form>
          ...
          <div class="row my-3 mx-5 pt-3">
            <h2>Actualización de Personal</h2>
          </div>
          ...
          <!--Botones finales-->
          <div class="row justify-content-end" id="BotonesInicio">
              <div class="col-auto">
                <div class="btn-group align-self-center" role="group" >
                  ...
                  <button type="button" id="Buscar" class="btn btn-info BotonPersonalizado btn-lg">Buscar</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col" id="BusquedaEncontrada">
        <!--Formulario de que se encontró al personal-->
        <form>
          ...
          <div class="form-check mx-5 pb-3">
            <input class="form-check-input" type="checkbox" value="" id="MantenerContraseña">
            <label class="form-check-label" for="MantenerContraseña">No cambiar la contraseña</label>
          </div>
          <!--Nombre del Personal-->
          <div class="form-group row m-2 aling-items-center align-self-center">
          ...
          <div class="row justify-content-end">
            <div class="col-auto">
              <div class="btn-group align-self-center" role="group" >
                <button type="button" id="Regresar2" class="btn btn-info BotonPersonalizado btn-lg">Regresar</button>
  ...
  <script src="js/mainAPe.js"></script>
</body>
</html>